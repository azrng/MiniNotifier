...
public sealed class ReminderMessageService : IReminderMessageService
{
    ...
    [
        ...
        "能把日程撑起来的人，通常也不差这一口补水。",
        "你现在这股稳定输出的劲头挺好，别被口干拖后腿。",
        "你今天已经够靠谱了，身体这边也别让它掉链子。",
        "这种在线状态很难得，别让嘴唇先摆烂。",
        "你现在这股认真劲挺加分，补点水会更从容。",
        "说真的，你这会儿没必要和水杯冷战。",
        "你这会儿的状态还不错，别演成硬撑版。",
    ...
    [
        ...
        "今天的嘴唇不想再陪你演沙漠求生了。",
        "工位空气已经看出你有点该喝水了。",
        "再拖一会儿，水杯都要开始怀疑自己的职业方向。",
        "这口水现在喝，至少能证明你还记得照顾自己。",
        "别让水杯一直在旁边独自营业，你多少给点反应。",
        "今天这次补水，主打一个别再嘴硬。",
        "这一步很简单，主要难在你总爱往后拖。",
        "你的水杯今天戏份不多，就等你别再晾着它。",
    ...
    {
        var usePraiseAccent = Random.Shared.NextDouble() < 0.46;
        var usePlayfulAccent = Random.Shared.NextDouble() < 0.72;
    ...
    private static string GetActivityContext(MouseActivitySnapshot snapshot)
    {
        return NormalizeSentence(snapshot.WorkState switch
        {
            ...
            [
                ...
                "刚才的点击节奏偏少，更像是在专注读写、思考或整理内容，别专注到把嘴唇也省电了。",
            ...
            [
                ...
                "刚才这段时间像是在正常流速处理事情，不急不躁，就是有点容易把自己忘了。",
                "你的鼠标节奏挺顺，像是在稳定推进当前任务，这时候喝两口最不打扰节奏。",
                "这类平稳工作状态最适合顺手补一口，不会打乱节奏。"
            ]),
            WorkIntensityState.ActiveHandling => Pick(
            [
                "最近这段时间点击挺密，像是在来回处理不少事项，忙得很认真。",
                "看起来你刚刚切换和操作都不少，明显在高频推进任务，所以更别装作不渴。",
                "你这会儿的点击活跃度挺在线，像是在密集处理事情，顺手补水刚好降点燥。",
                "刚才的鼠标节奏偏快，像是在多任务之间灵活穿梭，也别把自己切到缺水模式。",
            ...
            [
                ...
                "最近鼠标几乎没闲着，这通常意味着你正在快速切换和处理，也意味着你大概率又忘了水。",
                "你刚才节奏挺快，这口水刚好帮你缓一下。"
            ])
        });
    }
